...
public class Admins extends Table
{
	...
	public Admins(DbHelper db){ super(db, TB_NAME, FIELDS); }

	public boolean addNewAdmin(String email, String password){ return addNewAdmin(email, password, 0); }
	public boolean addNewAdmin(String email, String password, int initialBalance)
	{
